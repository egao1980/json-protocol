...
(defmethod serdes-protocol:backend-encode ((backend yaml-serdes-backend) value &key stream)
  (declare (ignore backend))
  (encode value :stream stream))

(defmethod serdes-protocol:backend-decode ((backend yaml-serdes-backend) source &key)
  (declare (ignore backend))
  (decode source))
